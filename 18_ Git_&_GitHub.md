...
##  Notes / Assumptions
1.	Your repo is named CodeTrack and already initialized with Git.
2.	Default branch might be master or main depending on Git version/settings (both are okay).
3.	For EC2, you may use Ubuntu or Amazon Linux. Steps provided for both.
...
1.	Open GitHub repo: Week-2---Git-GitHub-Assignment
...
Follow the instructions inside index.html (from the comment block):
1.	Change Student Name & Group Name
2.	Save file and refresh browser

Confirm Git sees modification:
...
3.	SSH (22) from your IP
4.	HTTP (80) from anywhere (0.0.0.0/0) for testing
...
1.	Your default branch is either main or master. Use whichever exists.
2.	If you see neither main nor master, you will identify your default branch via git branch.
...
##  ✅ Expected:
1.	git status shows a clean working tree (or at least no unexpected changes)
2.	You can see your branches and identify the default branch
...
1.	Open index.html in your browser on the default branch
2.	Confirm the “Contact Page” link is missing
...
1.	Contact link should appear 
2.	Click it → Contact page should open 
...
1.	Repo name is devops-micro-internship-interviews .
2.	You must clone your fork, not the upstream repo directly.
3.	You will edit ONE target file only (recommended: pull_request.md OR README.md).
...
•	You now have: 
	...
	yourusername/devops-micro-internship-interviews
...
Fill token details:
a.	Note: DMI-Git-HTTPS
b.	Expiration: 30 days (or 90 days if you prefer)
c.	Scopes (Permissions):  repo
...
2.	Password: paste your Personal Access Token (PAT) (NOT your GitHub password)

##   Expected outcome: 
Push succeeds without “authentication failed”.

##  Clone Your Fork Locally + Setup Remotes
Goal: You have a local copy where:
a.	origin = your fork
b.	upstream = original repository
...
##  ✅ Expected outcome:
1.	origin → your fork
2.	upstream → pravinmishraaws repo

##  Industry Note
This is the standard model for contributions:
1.	Pull updates from upstream
2.	Push your work to origin
3.	PR from origin branch → upstream main
...
a.	✅ Add your name at the end only
b.	❌ Do not edit/delete anyone else
